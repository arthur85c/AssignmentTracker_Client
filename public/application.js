...
var showAssignmentsTemplate = __webpack_require__(16);

var createAssignmentSuccess = function createAssignmentSuccess(data) {
  $('#createItemModal').modal('hide');
  $('#create-item-form')[0].reset();
};

var createAssignmentError = function createAssignmentError() {
  $('#createModalLabel').css('color', 'red');
  $('#createModalLabel').html('Something went wrong creating the assignment try again!');
};

var getAssignmentsSuccess = function getAssignmentsSuccess(data) {
  var showNewAssignmentsHtml = showAssignmentsTemplate({ assignments: data.assignments });
  $('#assignmentList').html(showNewAssignmentsHtml);
};

var getAssignmentsFailure = function getAssignmentsFailure() {
  $('#assignmentTitle').css('color', 'red');
  $('#assignmentTitle').html('Something went wrong loading assignments try again!');
};

var deleteAssignmentError = function deleteAssignmentError() {
  $('#assignmentTitle').css('color', 'red');
  $('#assignmentTitle').html('Something went wrong deleting assignment try again!');
};

var updateAssignmentSuccess = function updateAssignmentSuccess(assignmentId) {
  $('[data-id="modal' + assignmentId + '"]').modal('hide');
  $('.modal-backdrop').remove();
  $('.update-form')[0].reset();
};
var updateAssignmentError = function updateAssignmentError() {
  $('.itemUpdateTitle').css('color', 'red');
  $('.itemUpdateTitle').html('Something went wrong updating item try again!');
};

var resetUiHandleing = function resetUiHandleing() {
...
module.exports = {
  ...
  createAssignmentError: createAssignmentError,
  deleteAssignmentError: deleteAssignmentError,
  getAssignmentsSuccess: getAssignmentsSuccess,
  getAssignmentsFailure: getAssignmentsFailure,
  updateAssignmentError: updateAssignmentError,
  updateAssignmentSuccess: updateAssignmentSuccess,
  resetUiHandleing: resetUiHandleing
};
...
var store = __webpack_require__(3);
var assignmentUi = __webpack_require__(4);
...
var assignmentUi = __webpack_require__(4);
var assignmentApi = __webpack_require__(35);

var onGetAssignments = function onGetAssignments(data) {
  assignmentUi.resetUiHandleing();
  assignmentApi.getAssignments().then(assignmentUi.getAssignmentsSuccess).catch(assignmentUi.getAssignmentsFailure);
};
var onCreateAssignment = function onCreateAssignment(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  assignmentApi.createAssignment(data).then(assignmentUi.createAssignmentSuccess).then(onGetAssignments).catch(assignmentUi.createAssignmentError);
};
var onDeleteAssignment = function onDeleteAssignment(event) {
  event.preventDefault();
  assignmentUi.resetUiHandleing();
  var assignmentId = $(event.target).attr('data-id');
  assignmentApi.deleteAssignment(assignmentId).then(onGetAssignments).catch(assignmentUi.deleteAssignmentError);
};
...
var onUpdateAssignment = function onUpdateAssignment(event) {
  ...
  var data = getFormFields(event.target);
  var assignmentId = $(event.target).attr('data-id');
  assignmentApi.updateAssignment(data, assignmentId).then(function () {
    return assignmentUi.updateAssignmentSuccess(assignmentId);
  }).then(onGetAssignments).catch(assignmentUi.updateAssignmentError);
};

var onOpenUpdateModal = function onOpenUpdateModal(event) {
  assignmentUi.resetUiHandleing();
  var assignmentId = $(event.target).attr('data-id');
...
var confettiRain = function confettiRain() {
  $('#my-canvas').show();
  confetti.render();
  setTimeout(function () {
    confetti.clear();
...
var confettiRainReset = function confettiRainReset() {
  $('my-canvas').show();
};
...
module.exports = {
  ...
  confettiRainReset: confettiRainReset
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var assignmentEvents = __webpack_require__(10);
var assignmentUi = __webpack_require__(4);
...
var getFormFields = __webpack_require__(6);
var authUi = __webpack_require__(7);
var authApi = __webpack_require__(34);
var assignmentEvents = __webpack_require__(10);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(authUi.signInSuccess).then(assignmentEvents.onGetAssignments).catch(authUi.signInError);
};

var onChangePW = function onChangePW() {
  event.preventDefault();
  var data = getFormFields(event.target);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"handlebars\"> <br>\n<ul class=\"list-group\">\n  <div class=\"titlecard\"> <li class=\"list-group-item\">To Do:</li> </div>\n  <li class=\"list-group-item\">Title: "
    ...
    + "\" class=\"updateButton btn btn-primary\">Update Item</button>\n    <button type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"deleteButton btn btn-primary\">Delete Item</button>\n    <button type=\"button\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"confettiButton btn btn-primary\">COMPLETED!</button>\n</div>\n  </li>\n</ul>\n\n\n<!--  Update Modal Starts Here -->\n      <div class=\"modal fade updateModal\" data-id=\"modal"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title itemUpdateTitle\">Update Assignment</h5>\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n            </div>\n            <div class=\"modal-body\">\n              <form class=\"update-form\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                 <div class=\"form-group\">\n                  <label for=\"formGroupExampleInput\">Title</label>\n                  <input name = \"assignment[title]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"form-control\">\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"formGroupExampleInput2\">Description</label>\n                  <input  name =\"assignment[description]\" class=\"form-control\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
    + "\"></input>\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"formGroupExampleInput3\">Status</label>\n                  <input  name =\"assignment[status]\" class=\"form-control\" type=\"text\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.status : stack1), depth0))
    + "\"></input>\n                </div>\n                <div class=\"modal-footer\">\n                  <button type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"  class=\"updateSubmitButton btn btn-primary\">Update</button>\n                  <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n                </div>\n              </form>\n            </div>\n          </div>\n        </div>\n      </div>\n    <br>\n\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.assignments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</div>\n";
...
var createAssignment = function createAssignment(data) {
  return $.ajax({
    method: 'POST',
...
var updateAssignment = function updateAssignment(data, assignmentId) {
  return $.ajax({
    method: 'PATCH',
...
var getAssignments = function getAssignments(data) {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + '/assignments',
    headers: {
...
var deleteAssignment = function deleteAssignment(assignmentId) {
  return $.ajax({
    method: 'DELETE',
    url: config.apiUrl + '/assignments/' + assignmentId,
    headers: {
